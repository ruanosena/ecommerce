...
export default async function Page({ searchParams }: PageProps) {
  ...
  return (
    <main className="mx-auto flex max-w-3xl flex-col items-center space-y-5 px-5 py-10">
      <h1 className="text-3xl font-bold">Nós recebemos seu pedido!</h1>
      <p>Um resumo do seu pedido foi enviado para seu endereço de e-mail.</p>
